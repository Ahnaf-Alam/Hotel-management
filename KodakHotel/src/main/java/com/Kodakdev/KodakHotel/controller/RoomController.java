...
import com.Kodakdev.KodakHotel.service.IRoomService;
...
public class RoomController {
    ...
    public ResponseEntity<Response> addNewRoom(@RequestParam(value = "photo", required = false) MultipartFile photo,
        ...
        validateRoom(photo, roomType, roomPrice, roomDescription);
    ...
    public ResponseEntity<Response> getAvailableRoomsByDateAndType(@RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate checkInDate,
        ...
        if(checkInDate == null || checkOutDate == null || roomType.isBlank()) {
            ...
            response.setMessage("Provide a valid check in date or check out date");
    ...
    private void validateRoom(MultipartFile photo, String roomType, BigDecimal roomPrice, String roomDescription) {
        if(photo == null || photo.isEmpty() || roomType == null || roomType.isBlank() || roomPrice == null || roomDescription.isEmpty()) {
            throw new BusinessException("Room is not valid");
        }
    }
}
